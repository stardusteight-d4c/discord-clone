              ...
              <FormControl>
                <div className="relative p-4 pb-6">
                  ...
                  <Input
                    ...
                    className="px-14 py-6 bg-zinc-200/50 dark:bg-zinc-700/75 border-none border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200"
                    {...field}
                  />
